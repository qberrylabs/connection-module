<div class="bg-light shadow-sm rounded py-4 mb-4">
    <div class="d-flex justify-content-between">
        <h3 class="text-5 font-weight-400 d-flex align-items-center px-4 mb-3">{{ucfirst($type)}} Connections</h3>
        <a href="#create-connection" data-toggle="modal" class="btn btn-link">Add Connection</a>
    </div>
    ...
    <div class="transaction-title py-2 px-4">
        <div class="row">
            ...
            @if (Request::is('connections/all'))
                <div class="col-3 col-sm-5 text-right"></div>
            @endif
